...
RSpec.describe Triclops::RasterCache do
  ...
  context '#cache_path' do
    it 'returns the expected value' do
      expect(instance.cache_path(identifier, raster_opts)).to eq(File.join(cache_directory, 'c7/b0/1c/2c/c7b01c2c7f3383eba7c7e993ab921f5a8dc06421f67120d7dfe8735673fc2d32/full/full/0/color.png'))
    end
  end
end
