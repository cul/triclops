namespace :triclops do
  ...
  task ci_nocop: ['triclops:setup:config_files', :environment, 'triclops:ci_specs']

  desc 'CI build with Rubocop validation'
  task ci: ['triclops:setup:config_files', :environment, 'triclops:rubocop', 'triclops:ci_specs']
  ...
  task ci_specs: :environment do
    ...
    duration = Benchmark.realtime do
      ...
      begin
        Rake::Task['triclops:rspec'].invoke
      rescue SystemExit => e
